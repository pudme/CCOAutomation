...
ANTHROPIC_TOOL_SCHEMAS: list[dict[str, Any]] = [
    ...
    {"name": "update_control_status", "description": "Update control status. status must be one of: not_started, in_progress, evidenced, risk_accepted, not_applicable. notes is optional.", "input_schema": {"type": "object", "properties": {"control_id": {"type": "string"}, "framework": {"type": "string"}, "status": {"type": "string"}, "notes": {"type": ["string", "null"]}}, "required": ["control_id", "framework", "status"]}},
